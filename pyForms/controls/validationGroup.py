...
class Control(pyForms.ControlBase.Base):
	...
	def render(self):
		...
		for validator in self.validators:
			if 'id' in validator.attributes:
				validator.attributes['id'] = validator.control.attributes['id'] + "_validator_" + str(self.validatorIndexCount)
			else:
				validator.attributes['id'] = "validator_" + str(self.validatorIndexCount)

			if 'id' not in validator.control.attributes:
				validator.control.attributes['id'] = "uniddcontrol_" + str(self.validatorIndexCount)
